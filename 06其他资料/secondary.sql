...
Source Server         : cdb-4fzy13us.bj.tencentcdb.com
Source Server Version : 50718
Source Host           : cdb-4fzy13us.bj.tencentcdb.com:10173
Source Database       : secondary

Target Server Type    : MYSQL
Target Server Version : 50718
File Encoding         : 65001

Date: 2019-10-15 09:18:58
*/
...
CREATE TABLE `address` (
  ...
  `province` int(4) DEFAULT '0' COMMENT '收货人地址所在省',
  `city` tinyint(2) DEFAULT NULL COMMENT '收货人地址所在市',
  `district` datetime DEFAULT NULL COMMENT '收货人地址所在区/县',
  `street` varchar(50) DEFAULT NULL COMMENT '收货人地址所在街道',
  `address_detail` datetime DEFAULT NULL COMMENT '收货人详细地址',
  `is_default_address` varchar(50) DEFAULT NULL COMMENT '是否默认地址 1-是 2-否',
  `create_time` varchar(50) DEFAULT NULL COMMENT '创建时间',
  `update_time` varchar(50) DEFAULT NULL COMMENT '修改时间',
  `status` varchar(255) DEFAULT NULL COMMENT '状态 1-有效 2-无效',
  PRIMARY KEY (`id`)
...
CREATE TABLE `order` (
  ...
  `consignee_mobile` varchar(20) DEFAULT NULL COMMENT '收货人手机号',
  `consignee_name` varchar(50) DEFAULT NULL COMMENT '收货人姓名',
  `consignee_address` varchar(500) DEFAULT NULL COMMENT '收货人地址',
...
CREATE TABLE `payment_log` (
  ...
  `request_params` varchar(2000) DEFAULT NULL COMMENT '支付请求参数',
  PRIMARY KEY (`id`)
